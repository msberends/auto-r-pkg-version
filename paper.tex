...
\emph{Cladophia\-lophora}, \emph{Cladosporium}, \emph{Conidiobolus},
...
\code{filter\_carbapenems(result = "R")} returns data of all isolates with
tested resistance to any of the 14 available antimicrobial agents in in the
group of carbapenems according to the \code{antibiotics} data set.
